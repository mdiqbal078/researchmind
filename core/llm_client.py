...
async def generate_completion(prompt: str, system_prompt: str = "", model: str = "llama-3.3-70b-versatile", response_format: str = "text") -> str:
    """
...
async def generate_completion_stream(prompt: str, system_prompt: str = "", model: str = "llama-3.3-70b-versatile"):
    """
...
async def generate_json(prompt: str, system_prompt: str, model: str = "llama-3.3-70b-versatile") -> dict:
    """
